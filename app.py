...
st.title('Can Toronto afford to buy top players')
st.sidebar.header('Player Data')
image = Image.open('Toronto_Raptors_logo.png')
st.image(image, 'Toronto Basketball')
...
# consolidating all the user inputs from slider and printing them as a dataframe
...
# computing the salary based on the predictions
